...
export function generateLocationMetadata(citySlug: string, service: string) {
  ...
  const description = `Professional ${serviceKeywords[0].toLowerCase()} for ${location.city} businesses. ${serviceKeywords.slice(1, 3).join(', ')} and more. Serving ${cityState} area.`;
...
export function generateLocalBusinessSchema(citySlug: string, service: string) {
  ...
  return {
    ...
    "description": `Professional ${service} services in ${location.city}, ${location.state}. ${serviceKeywords.join(', ')} and more.`,
...
export function generateOrganizationSchema() {
  ...
  return {
    ...
    "url": baseUrl,
    "logo": `${baseUrl}/kps-group/kps-square-512.png`,
    "description": "Modern Suite for business operations including payroll, bookkeeping, branding, consulting, and software solutions.",
    "foundingDate": "2020",
    "founders": [
      {
        "@type": "Person",
