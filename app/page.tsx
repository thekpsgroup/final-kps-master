          ...
          <div className="container max-w-4xl relative">
            <div className="text-center text-white">
              ...
              <p className="text-xl text-white/90 max-w-3xl mx-auto leading-relaxed mb-8">
                We partner with exceptional business owners who deserve premium back-office support.
                You shouldn&apos;t waste time on bookkeeping, payroll headaches, tech support calls,
                or website updates. You should be growing your business with clear, accurate
                information and strategic guidance.
              </p>
